...
BOT_TOKEN = environ.get('BOT_TOKEN', "6128163698:AAHScM4OrTVm5ncbaiv1Bt_G4hDGMBQtjdo")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001921446982').split()
...
URL = "https://uhdv2.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://uhdv2.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://uhdv2.onrender.com/".format(FQDN)
else:
    URL = "https://uhdv2.onrender.com/".format(FQDN)
