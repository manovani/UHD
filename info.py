...
BOT_TOKEN = environ.get('BOT_TOKEN', "6128163698:AAH7WLH9Nuofe0mOwM5rUusfViYqQoYac-c")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/2bf5bb32bbc4ee87099d7.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/df85b2b9b5666d04d9b43.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/096dc02c579812ce5d468.jpg")
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001921446982')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001921446982')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mrprince24gopriya:Cluster143@cluster143.ci2gq1i.mongodb.net/?retryWrites=true&w=majority")
...
MSG_ALRT = environ.get('MSG_ALRT', 'Telegram - Join ⚡ @UHD_Tamil')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001906074061'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'UHD_Tamil')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002081216638')).split()]
...
URL = "https://uhdtamilv2.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://uhdtamilv2.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://uhdtamilv2.onrender.com/".format(FQDN)
else:
    URL = "https://uhdtamilv2.onrender.com/".format(FQDN)
